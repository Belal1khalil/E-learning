...
export default function InstructorsCard({ CardInfo }) {
    // eslint-disable-next-line react/prop-types
    const { displayName, email, imageCover, jobTitle, mobile } = CardInfo;

    return (
        <div className="relative my-4  rounded-xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-2xl group">
            {/* Image Section */}
            ...
            <div className="p-6 text-center bg-white">
                ...
                <p className="text-sm text-gray-600 uppercase tracking-widest mb-4">{jobTitle}</p>
